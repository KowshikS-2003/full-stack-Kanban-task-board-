...
const TOKEN_KEY = 'quicktask_token';
const USER_KEY  = 'quicktask_user';
...
function showAuthView() {
    ...
    document.getElementById('board-container').hidden = true;
...
function showBoardView() {
    ...
    document.getElementById('board-container').hidden = false;
    const user = getUser();
    if (user) {
...
// -------------------------------------------------------
// In-memory cache, edit-mode, search state
// -------------------------------------------------------
